...
payload = {"rawlog": ""+name+" Rolled Back", "device_id": ""+device_id+"", "date": ""+time1+"", "customer_ref": "TyrellCorp", "severity": "5", "type": "NOTIFICATION", "subtype": "WF"}
...
ret = MSA_API.process_content('ENDED', f'{context["construction_name"]} Rolled Back', context, True)
print(ret)