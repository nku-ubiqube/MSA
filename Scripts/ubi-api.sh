...
curl --insecure -H 'Accept: application/json' -H'Content-Type: application/json' -H "Authorization: Bearer $key" -XGET https://127.0.0.1/ubi-api-rest/orchestration/v1/service/process-instance/75
echo "-------------------Get MS List----------------------"
